...
#define PCLKSEL0_Val          0x00000014		/* set Peripheral clock selection for TIMER0 to PCLK_peripheral = CCLK */
#define PCLKSEL1_Val          0x00005000		/* set Peripheral clock selection for TIMER2 and TIMER3 to PCLK_peripheral = CCLK */
